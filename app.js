...
function renderNights(){
  ...
  state.nights.forEach((night, idx)=>{
    ...
    const thead=el('thead',{}, el('tr',{}, el('th',{},'A'), el('th',{},'→ B')));
    ...
    card.append(
      el('div',{class:'row'}, el('strong',{}, `Matching Night ${idx+1}`), el('span',{class:'pill'}, 'jede Frau max. einmal')),
      table,
      el('div',{class:'row'}, el('span',{},'Lichter:'), beams, del)
    );
    box.append(card);
...
function solve(){
  // Overlay zeigen + 2s Ladeleiste, danach rechnen
